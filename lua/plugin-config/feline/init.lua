-- ~/.config/nvim/lua/plugin-config/feline/init.lua

local colors = require 'plugin-config/feline/colors'
...
local comps = {
    ...
    file = {
        info = {
            -- provider = 'file_info',
            provider = require("plugin-config/feline/file_name").get_current_ufn,
            hl = {
                fg = colors.blue,
                style = 'bold'
            },
